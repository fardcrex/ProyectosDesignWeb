<template>
  <div class="page-container">
    ...
    >
      <div
        class="w3-image-portada"
        src="../assets/img_page_azura/portada.jpg"
        alt="Me"
        width="1500"
        height="500"
      ></div>
      <div class="w3-display-middle w3-padding-large w3-border w3-wide w3-text-light-grey w3-center">
        <h1 class="w3-hide-medium w3-hide-small w3-xxxlarge">LUNA AZURA</h1>
        <h5
          class="w3-hide-large"
          style="white-space:nowrap"
        >LUNA AZURA</h5>
        <h3 class="w3-hide-medium w3-hide-small">FOTÓGRAFA</h3>
      </div>

      <!-- Navbar (Lugar del boton de la cabezera) -->
      <div
    ...
    <!-- Page content -->
    <div
      class="w3-content w3-padding-large w3-margin-top"
      id="portfolio"
    >
      ...
      >
        ...
        <hr>
        <p>Si quieres entrar en contacto deja su mensaje con tu información de contacto.</p>
...
$color-gradient: linear-gradient(
  -10deg,
  rgba(48, 207, 208, 0.6) 0%,
  rgba(98, 8, 103, 0.5) 100%
);
...
.w3-image-portada {
  ...
  background: $color-gradient,
    url("../assets/img_page_azura/portada.jpg") center no-repeat;
  position: relative;
